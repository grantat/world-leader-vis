...
function bubbleChart() {
  ...
  var width = $(".top-vis").width();
  var height = $(".top-vis").height();
  ...
  function createNodes(rawData) {
    ...
    var maxAmount = d3.entries(rawData)
  ...
  function showDetail(d) {
    ...
    for(pic in d.profiles){
        pics += '<img id="tip-user" class="profile-img-hover" src="'+d.profiles[pic]+'" onerror="imgError(this)">';
    }

    var content = '<span class="name">Word/Emoji: </span><span class="value">' +
                  capitalizeFirstLetter(d.name) +
                  '</span><br/>' +
                  '<span class="name">Count: </span><span class="value">' +
                  addCommas(d.value) +
                  '</span><br/>' +
                  '<span class="name">Users: </span><span class="value">' +
                  pics +
                  '</span>';
...
function display(error, data) {
  ...
  myBubbleChart('.top-vis svg', data);
}
